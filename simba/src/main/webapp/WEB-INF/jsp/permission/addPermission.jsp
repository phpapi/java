...
<body style="padding: 0px; margin: 0px">
	...
	<div class="easyui-panel" title="新增权限" style="width: 700px">
		<div style="padding: 10px 60px 20px 60px">
			<form id="permissionForm" method="post">
				<table cellpadding="0" cellspacing="0" style="table-layout: fixed;">
					<tr>
						<td>名称:</td>
						<td><input class="easyui-textbox" type="text" id="text" name="text" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>URL地址:</td>
						<td><input class="easyui-textbox" type="text" id="url" name="url" data-options="width:500,multiline:true,height:60,prompt:'多个url使用英文逗号隔开'"></input></td>
					</tr>
					<tr>
						<td>父权限:</td>
			...
			<div style="text-align: center; padding: 5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="Permission.add();" data-options="iconCls:'icon-add'">新增</a> <a href="javascript:void(0)" class="easyui-linkbutton"
