...
<body style="padding:0px;margin:0px">
	...
	<div class="easyui-panel" title="新增菜单" style="width:700px">
		<div style="padding:10px 60px 20px 60px">
			...
			<div style="text-align:center;padding:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="Menu.add();" data-options="iconCls:'icon-add'">新增</a> <a href="javascript:void(0)" class="easyui-linkbutton"
